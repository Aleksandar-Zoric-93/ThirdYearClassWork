...
public class CP3LinkedList<E> {
	...
	*/
	...
	{  
        ...
        {
            if(head.next != null) 
            { // recurse until the last node is found
                printSub(head.next);  // print the next node first
            }
                System.out.println(head.data); // print out the node(this is only reached after the last is found
